 ...
 *
 * @author aman & damodar This file is the main file to load the GUI and read the file and
 * display the energy data USER
*  Username and password could be given any number and letters
* 
* */
...
//                        userNameField.setText(null);
        ...
        displayAllButton.addActionListener((ActionEvent arg0) -> {
            ...
            {
               JOptionPane.showMessageDialog(getParent(),"No any records found");
            }
        });
    }
